...
public class BasicController : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        for (int i = 0; i < 10; i++)
        {
            ...
            {
                case 0:
                    FollowButtons[tem].onClick.AddListener(FC1);
                    break;
                case 1:
                    FollowButtons[tem].onClick.AddListener(FC2);
                    break;
                case 2:
                    FollowButtons[tem].onClick.AddListener(FC3);
                    break;
                case 3:
                    FollowButtons[tem].onClick.AddListener(FC4);
                    break;
                case 4:
                    FollowButtons[tem].onClick.AddListener(FC5);
                    break;
                case 5:
                    FollowButtons[tem].onClick.AddListener(FC6);
                    break;
                case 6:
                    FollowButtons[tem].onClick.AddListener(FC7);
                    break;
                case 7:
                    FollowButtons[tem].onClick.AddListener(FC8);
                    break;
                case 8:
                    FollowButtons[tem].onClick.AddListener(FC9);
                    break;
                case 9:
                    FollowButtons[tem].onClick.AddListener(FC10);
                    break;
                default:
                    break;
            }
