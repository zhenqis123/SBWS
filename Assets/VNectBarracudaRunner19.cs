...
/// Define Joint points
/// </summary>
public class VNectBarracudaRunner19 : MonoBehaviour
{
    /// <summary>
    ...
    public VNectModel19 VNectModel;
    ...
    /// </summary>
    private VNectModel19.JointPoint[] jointPoints;
    ...
    */
    ...
    private void PredictPose()
    {
        ...
        jointPoints[PositionIndex19.neck.Int()].Now3D = (jointPoints[PositionIndex19.rShldrBend.Int()].Now3D + jointPoints[PositionIndex19.lShldrBend.Int()].Now3D) / 2f;

        // Calculate hip location
        /*var lc = (jointPoints[PositionIndex19.rThighBend.Int()].Now3D + jointPoints[PositionIndex19.lThighBend.Int()].Now3D) / 2f;
        jointPoints[PositionIndex19.hip.Int()].Now3D = (jointPoints[PositionIndex19.spine.Int()].Now3D + lc) / 2f;*/

        

        // Calculate head location
        var cEar = (jointPoints[PositionIndex19.rEar.Int()].Now3D + jointPoints[PositionIndex19.lEar.Int()].Now3D) / 2f;
        var hv = cEar - jointPoints[PositionIndex19.neck.Int()].Now3D;
        var nhv = Vector3.Normalize(hv);
        var nv = jointPoints[PositionIndex19.Nose.Int()].Now3D - jointPoints[PositionIndex19.neck.Int()].Now3D;
        jointPoints[PositionIndex19.head.Int()].Now3D = jointPoints[PositionIndex19.neck.Int()].Now3D + nhv * Vector3.Dot(nhv, nv);

        // Calculate spine location
        jointPoints[PositionIndex19.spine.Int()].Now3D = jointPoints[PositionIndex19.spine.Int()].Now3D;
    ...
    void KalmanUpdate(VNectModel19.JointPoint measurement)
    {
	...
	void measurementUpdate(VNectModel19.JointPoint measurement)
    {
