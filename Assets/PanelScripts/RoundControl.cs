...
public class RoundControl : MonoBehaviour, IPointerDownHandler, IDragHandler, IPointerUpHandler
{
    ...
    private void Update()
    {
        if (isPressed)
        {
            ...
            // 应用方向和速度到物体的移动
            objectToMove.Translate(new Vector3(direction.x, 0f, direction.y) * speed * Time.deltaTime, Space.World);
        }
    }
